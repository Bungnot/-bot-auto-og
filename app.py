...
BANK_ACCOUNT_NUMBER = "760-9-80752-9"
BANK_ACCOUNT_DISPLAY_NUMBER = "760-9-80752-9"
BANK_ACCOUNT_BANK = "ทีทีบีธนชาต"
BANK_ACCOUNT_NAME = "กิติพร ศักดิ์ศรี"
...
def new_member_instruction_text() -> str:
    return (
        ...
        "ชื่อ: คิดยอด OG V2 ก่อนนะคะ\n\n"
        "✅ เมื่อลูกค้าทัก แล้ว ระบบจะรู้จักสมาชิก\n"
